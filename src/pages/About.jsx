    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #071e52 0%, #0f4db5 55%, #2277ee 100%)' }}>
      ...
      <div className="pt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-5xl font-bold text-white mb-8" style={{ fontFamily: 'Syne' }}>About Sentra</h1>

          <div className="space-y-8 text-slate-300">
            <section>
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'Syne' }}>Our Mission</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'Syne' }}>What We Do</h2>
              ...
              <ul className="space-y-3">
                <li className="flex gap-3">
                  <span className="text-[#7ab8f5]">✓</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'Syne' }}>Why Choose Us</h2>
              <ul className="space-y-3">
                <li className="flex gap-3">
                  <span className="text-[#2277ee]">→</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'Syne' }}>Our Technology</h2>
              <p className="text-lg leading-relaxed">
